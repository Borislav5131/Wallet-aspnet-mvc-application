...
namespace Wallet.Infrastructure.Data.Migrations
{
    ...
    [Migration("20220317134212_AddWallterAndExtendUser2")]
    partial class AddWallterAndExtendUser2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wallet.Infrastructure.Data.Models.Asset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Wallet.Infrastructure.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Wallet.Infrastructure.Data.Models.Asset", b =>
                {
                    b.HasOne("Wallet.Infrastructure.Data.Models.Category", "Category")
                        .WithMany("Assets")
